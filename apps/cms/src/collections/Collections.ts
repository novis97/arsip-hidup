...
export const Collections: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'descriptionShort', type: 'textarea', required: true, maxLength: 1200 },
    { name: 'descriptionLong', type: 'richText' },
    { name: 'region', type: 'text' },
    { name: 'periodStart', type: 'number' },
    { name: 'periodEnd', type: 'number' },
    { name: 'status', type: 'select', options: ['planned', 'active', 'completed'], defaultValue: 'active' },
    { name: 'funders', type: 'array', fields: [{ name: 'name', type: 'text', required: true }],
      admin: { description: 'HANYA mitra dan pendana yang benar-benar terlibat. Jangan cantumkan logo lembaga yang belum bermitra (RULES §1.6).' } },
  ],
};
